<template>
	<div class="product3" @click="introEvent">
		<div class="pic">
			<img src="http://7xj0kd.com2.z0.glb.qiniucdn.com/{{data.image}}?imageView2/1/w/300/h/300" alt="">
		</div>
		<h3 class="name">{{data.name}}</h3>
		<p class="intro">{{data.description | cut}}</p>
	</div>
	<div class="product-dock2">
